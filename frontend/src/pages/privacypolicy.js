  ...
  render() {
    return (
      <React.Fragment>
        ...
        <div id="aboutWrapper">
          <div id="aboutContent">
            <div className="aboutHeader">Privacy Policy</div>
            <div className="aboutText">
              <p>Last updated: January 04, 2021</p>
              <p>
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to Receiply.
                  </p>
                </li>
                <li>
                  <p>
                ...
                <li>
                  <p>
                    <strong>Country</strong> refers to: Washington, United
                    States
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to Receiply, accessible from{" "}
                    <a
              ...
              <ul>
                <li>By email: contact@receiply.com</li>
              </ul>
            </div>
          </div>
        </div>
